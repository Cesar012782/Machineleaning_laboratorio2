...
class MyKmeans:
    def __init__(self, k, num_points=10, dimension=2, lower_bound=(0, 0), upper_bound=(10, 10), points=None, centroids=None):
    ...
    def generate_points(self):
        self.points = np.random.uniform(low=self.lower_bound, high=self.upper_bound, size=(self.num_points, self.dimension))
        return self.points
